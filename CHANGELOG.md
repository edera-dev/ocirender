...
- *(squashfs)* retry mksquashfs spawn on ETXTBSY and sharpen spawn errors

### Other

- cache cargo across runs and install cargo-audit prebuilt
- *(github)* update actions pinning
- *(cli)* migrate TLS to rustls+ring for reqwest
